...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('crystal:category_detail', kwargs={'slug': self.slug})
...
class Product(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('crystal:product_detail', kwargs={'slug': self.slug})
